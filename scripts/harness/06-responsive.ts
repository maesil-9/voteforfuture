...
const CHECKS = [
  "/ (랜딩): 선거명·일정 타임라인이 줄바꿈 없이 읽힌다",
  "/vote/enter-code: 코드 입력 카드가 깨지지 않고, 모바일 키보드에서 입력이 편하다",
  "/vote/enter-code: 코드 붙여넣기 시 하이픈이 자동 정리된다",
  ...
  "/vote/[id]/complete: 도장 찍힌 완료 카드가 잘리지 않는다",
  "/results/[id]: 봉인 패널/결과 막대가 폭에 맞게 변한다",
  "/admin: 메트릭 스트립이 모바일에서 세로로 쌓인다",
  "/admin/.../voters: 배치 테이블이 모바일에서 무너지지 않는다 (가로 스크롤 허용)",
